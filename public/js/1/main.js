...
window.onload = function() {
	if (umb = document.getElementById('user-menu-button')) {
		umb.onclick = function() {
		document.getElementById('user-menu').classList.toggle('hide');
		};
	}

    if (cm = document.getElementById('compact-menu-action')) {
        cm.onclick = function() {
        document.getElementById('compact-menu').classList.toggle('noDisplay');
        };
    }
