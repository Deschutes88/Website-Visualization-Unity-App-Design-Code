...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="text" data-preset="default"><div class="moto-widget-text-content moto-widget-text-editable"><div style="height: 50px"></div></div></div><div data-animation="fadeIn" class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto wow fadeIn" data-widget="text" data-preset="default"><div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_4" style="font-family:'Lobster',cursive;text-shadow: 1px 1px 1px rgba(0,0,0,0.7);text-align: center;">EQUINE INTEL<br></p></div></div>
    <!--                         
...
<div data-widget-id="wid__button__59a5189c1c92d" class="moto-widget moto-widget-button moto-preset-default moto-align-center moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-large moto-spacing-left-auto " data-widget="button" style="padding-top: 0px;padding-bottom: 10px;">
            <a href="/test"   data-action="url" class="moto-widget-button-link moto-size-medium moto-link"><span class="fa moto-widget-theme-icon"></span> <span class="moto-widget-button-label">START YOUR TRIAL</span></a>
...
<div class="row">
    ...
    <ul style="margin-left: 32.5%;">

    <li style="float: left; padding-left: 0px;padding-right: 20px;">
    <div data-widget-id="wid__button__59a5189c1c92d" class="moto-widget moto-widget-button moto-preset-default moto-align-center moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-large moto-spacing-left-auto " data-widget="button" style="padding-top: 0px;padding-bottom: 10px;">
                <a href="{{ url('/login/facebook') }}"   data-action="url" class="moto-widget-button-link moto-size-medium moto-link"><i class="fa fa-facebook-f"></i> <span class="moto-widget-button-label">SIGN UP</span></a>
                
        </div>
    </li>
    <li style="float: left; padding-left: 30px;">
    <div data-widget-id="wid__button__59a5189c1c92d" class="moto-widget moto-widget-button moto-preset-default moto-align-center moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-large moto-spacing-left-auto " data-widget="button" style="padding-top: 0px;padding-bottom: 10px;">
                <a href="{{ url('/login/google') }}"   data-action="url" class="moto-widget-button-link moto-size-medium moto-link"><i class="fa fa-google"></i> <span class="moto-widget-button-label">SIGN UP</span></a>
                
        </div>
        </li>
    </ul>
</div>
<div style="padding-bottom: 9.8%;">
