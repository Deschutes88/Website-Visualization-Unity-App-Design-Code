        ...
        <!--========== END HEADER ==========-->
            ...
            </div></div><div class="moto-cell col-xs-11" data-container="container"><div data-spacing="sass" class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-small" data-widget="text" data-preset="default"><div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_12"><a class="moto-link" data-action="url" target="_self" href="callto: #">1-555-644-5566</a><br></p></div></div></div></div></div></div></div><div class="moto-cell col-sm-6" data-container="container"><div data-grid-type="xs" class="moto-widget moto-widget-row row-gutter-0" data-widget="row"><div class="container-fluid"><div class="row"><div class="moto-cell col-xs-1 undefined" data-container="container"><div data-widget-id="wid__image__59a5189c184c4" class="moto-widget moto-widget-image moto-preset-default  moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto " data-widget="image">
                        <div class="moto-widget-image-link">
            ...
            </div></div><div class="moto-cell col-xs-11" data-container="container"><div data-spacing="sass" class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-small" data-widget="text" data-preset="default"><div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_12">Studio City, CA 91604</p></div></div></div></div></div></div></div></div></div></div></div><div class="moto-cell col-sm-7" data-container="container"></div></div></div></div></div>
                    <div data-moto-sticky="{ }" data-css-name="moto-container_header_57b6cf462" class="moto-widget moto-widget-container moto-container_header_57b6cf462  navbar-fixed-top" data-widget="container" data-container="container" ><div class="moto-widget moto-widget-row row-fixed" data-widget="row"><div class="container-fluid"><div class="row"><div class="moto-cell col-sm-3 undefined" data-container="container"><div data-spacing="sasa" class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto" data-widget="text" data-preset="default"><div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_1"><a class="moto-link" data-id="1" data-action="page" href="/" style="     background-color: transparent;   text-shadow: 1px 1px 1px rgba(0,0,0,0.7);">EquineIntel</a><br></p></div></div></div><div class="moto-cell col-sm-6" data-container="container"><div data-widget-id="wid__menu__59a5189c19c1e" class="moto-widget moto-widget-menu moto-preset-default moto-align-center moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-preset="default" data-widget="menu">
    ...
    <a href="contacts/index.html"   data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-1 moto-link">CONTACTS</a>
        </li>
        @if (Auth::check())
                                    @if (Auth::guest())
